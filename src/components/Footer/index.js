  ...
  return (
    <FooterContainer>
      <FooterWrap>
        ...
        <SocialMedia>
          <SocialMediaWrap>
            <SocialMediaLogo onClick={toggleHome}><FaMagento style={{marginRight:"10px"}}/>VIGO CORP</SocialMediaLogo>
            <WebsiteRight  href="www.brighterdayscodelab.com.ng" target="new page"> 
